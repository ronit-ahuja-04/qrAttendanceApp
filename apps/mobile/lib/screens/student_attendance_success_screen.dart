...
class StudentAttendanceSuccessScreen extends StatefulWidget {
  const StudentAttendanceSuccessScreen({
    super.key,
  });

  @override
  State<StudentAttendanceSuccessScreen> createState() =>
      _StudentAttendanceSuccessScreenState();
}

class _StudentAttendanceSuccessScreenState extends State<StudentAttendanceSuccessScreen>
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Your attendance has been recorded and sent to the faculty for review. It will reflect on your dashboard shortly.',
