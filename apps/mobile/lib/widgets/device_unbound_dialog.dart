      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Message
            Text(
              'Device has been changed. Please use the other device. If you want to use this device, contact admin for login reset.',
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(26), // Card pill rounded style
                  ),
                ),
                child: const Text(
                  'Dismiss',
